...
import ir.greendex.mafia.databinding.LayerRvItemEditAnimBinding
...
class EditAnimAdapter @Inject constructor(private val context:Context):RecyclerView.Adapter<EditAnimAdapter.EditAnimVH>(){

    inner class EditAnimVH(val binding: LayerRvItemEditAnimBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(item: UserItemsEntity.UserItemData.UserItemsList) {
            binding.apply {
                anim.setAnimationFromUrl(BASE_URL.plus(item.file))
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EditAnimVH {
        return EditAnimVH(
            LayerRvItemEditAnimBinding.inflate(
    ...
    override fun onBindViewHolder(holder: EditAnimVH, position: Int) {
